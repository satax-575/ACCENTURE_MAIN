          ...
          {dispatchResult ? (
            ...
            <div className="space-y-4">
              <div className="p-5 bg-emerald-50 border border-emerald-200 rounded-2xl flex items-start gap-3.5">
                ...
                <div>
                  <h3 className="font-bold text-emerald-900 text-sm">Action Successfully Dispatched & Executed</h3>
                  <p className="text-xs text-emerald-700 mt-0.5">
                    Target: <span className="font-semibold capitalize">{dispatchResult.channel.replace('_', ' ')}</span> • Authorized by: <span className="font-bold uppercase">{dispatchResult.authorized_by}</span>
                  </p>
                  <div className="mt-2 text-xs font-mono font-bold bg-white px-2.5 py-1 rounded-md border border-emerald-300 text-emerald-900 inline-block">
                    Ref ID: {dispatchResult.external_reference}
                  </div>
                </div>
              </div>
              ...
              <div className="bg-slate-950 text-slate-100 p-4 rounded-2xl text-xs font-mono space-y-2 relative">
                ...
                <pre className="text-[11px] text-indigo-300 whitespace-pre-wrap max-h-48 overflow-y-auto">
